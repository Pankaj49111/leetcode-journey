<h1>2438 - Find Closest Node to Given Two Nodes</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/find-closest-node-to-given-two-nodes/">find-closest-node-to-given-two-nodes</a></h2><p>You are given a <strong>directed</strong> graph of <code>n</code> nodes numbered from <code>0</code> to <code>n - 1</code>, where each node has <strong>at most one</strong> outgoing edge.</p>
