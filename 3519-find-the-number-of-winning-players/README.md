<h1>3519 - Find the Number of Winning Players</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/find-the-number-of-winning-players/">find-the-number-of-winning-players</a></h2><p>You are given an integer <code>n</code> representing the number of players in a game and a 2D array <code>pick</code> where <code>pick[i] = [x<sub>i</sub>, y<sub>i</sub>]</code> represents that the player <code>x<sub>i</sub></code> picked a ball of color <code>y<sub>i</sub></code>.</p>
